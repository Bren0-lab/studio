...
export const initialDevices: Device[] = [
  ...
  { id: 'dev3', name: 'Luz do Quarto', power: 15, hours: 6, on: true, roomId: 'room1', x: 0.4, y: 0.17 },
  { id: 'dev4', name: 'Ar Condicionado', power: 1500, hours: 8, on: false, roomId: 'room2', x: 0.1, y: 0.17 },
  { id: 'dev5', name: 'Máquina de Lavar', power: 500, hours: 1, on: false, roomId: 'room6', x: 0.3, y: 0.05 },
  { id: 'dev6', name: 'Micro-ondas', power: 800, hours: 0.5, on: false, roomId: 'room5', x: 0.85, y: 0.15 },
  { id: 'dev7', name: 'Abajur', power: 25, hours: 3, on: true, roomId: 'room1', x: 0.45, y: 0.22 },
];
